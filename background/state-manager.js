...
class StateManager {
  ...
  async updateSettings(newSettings) {
    ...
    console.log("[StateManager] Settings updated and saved", this.settings);
  }
  ...
  async loadSettings() {
    try {
      ...
      if (result.settings) {
        ...
        console.log(
          "[StateManager] Settings loaded from storage",
          this.settings,
        );
      } else {
        console.log(
          "[StateManager] No saved settings, using defaults",
          this.settings,
        );
      }
    } catch (error) {
