...
class MatchingEngine {
  ...
  async runMatchingPipeline(normalizedQuery, keywords, options) {
    ...
    if (!hasData) {
      message =
        "No local data loaded and AI execution failed or provided no result.";
    } else if (!aiEnabled) {
      message =
        "No answer found. Try enabling AI Answering in settings to get answers for questions not in your database.";
    }
